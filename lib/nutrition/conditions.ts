...
export const CONDITIONS: ConditionOption[] = [
  ...
  { code: 'high_cholesterol', label: 'High Cholesterol', group: 'Cardiovascular' },
  { code: 'ckd_stage1', label: 'Chronic Kidney Disease Stage 1-2', group: 'Kidney' },
  ...
  { code: 'hyperthyroidism', label: 'Hyperthyroidism', group: 'Hormonal' },
  ...
  { code: 'gerd', label: 'GERD / Acid Reflux', group: 'Digestive' },
  { code: 'lactose_intolerance', label: 'Lactose Intolerance', group: 'Digestive' },
  { code: 'fatty_liver', label: 'Fatty Liver (NAFLD)', group: 'Metabolic' },
  { code: 'anemia', label: 'Anemia', group: 'Metabolic' },
